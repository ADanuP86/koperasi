<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Edit Data Jenis Simpanan</li>
    </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">Edit Data Jenis Simpanan</h3>
      </div>
    ...
    <div class="form-group">
      ...
      <input type="text" name="nama_simpanan" class="form-control" id="nama_simpanan" value="<?php echo $kpr->nama_simpanan ?>">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" name="besar_simpanan" class="form-control" id="besar_simpanan" value="<?php echo $kpr->besar_simpanan ?>">
    </div>
