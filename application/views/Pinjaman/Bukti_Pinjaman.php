...
<body>
    ...
    <table border="0">
      ...
      <p style="float:left;">Melakukan Pinjaman Uang Koperasi Mulya Abadi Sentosa Kampung Wates, sebesar <?php echo rupiah($pin->besar_pinjaman) ?>, yang akan diangsur selama <?php echo $pin->jumlah_angsur ?>x (kali).</p> <br>
